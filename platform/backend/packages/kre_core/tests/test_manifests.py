...
from kre_core.checksums import settings_hash
from kre_core.manifests import (
    ArtifactEntry,
    CompatibilityMatrix,
    ManifestError,
    SoftwareVersion,
...
def entry(role: str) -> ArtifactEntry:
    return ArtifactEntry(
        role=role,
        uri=f"kre://kre-model/eq/idn/v1/{role}",
...
def software() -> list[SoftwareVersion]:
    return [
        ...
        SoftwareVersion("kre-converter", "0.1.0", "sha256:bbb"),
    ]
