...
| [0007](0007-internal-use-licence-basis.md) | Model data is held under one internal-use basis | Accepted, amended by 0015 |
...
Record 0015 overtakes the plan's description of CASS as a governed decision
platform, and the plan marks those statements *Changed after 1.8*.
