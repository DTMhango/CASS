...
Needing a decision or outside input: the event representation study; a representation for multi-measure classes; realisation weighting; the storage format; secondary-peril and business-interruption scope; legal review before model data or a derived package leaves KRE; a Nepal source model, denser Vs30 and the licensed ~1 km exposure; approved benchmark curves and QA tolerances; the brief's section 5.1 data questions; and a full-country hazard run.
