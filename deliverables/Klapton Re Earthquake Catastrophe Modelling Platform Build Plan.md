...
| Nepal hazard source | No source model acquired, and none will be: Indonesia and Nepal were test countries and Indonesia is covered | Closed after 1.8 | Nepal maps keys and produces no loss |
...
Settled after 1.8: the event representation study is dropped; legal review before model data leaves KRE is cleared; Nepal acquires no hazard; and the multi-IMT representation, the realisation-weighting rule and the footprint storage format are CASS's to research and decide, as tracker items 21 to 23.
