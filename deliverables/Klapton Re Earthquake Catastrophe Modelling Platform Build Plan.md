...
> *Changed after 1.8.* GEM Foundation has replied to KRE's email of 11 September 2026. It acknowledged that the use KRE described does not violate its terms of use, and granted explicit permission to use the public Global Exposure and Vulnerability models ([ADR 15](../platform/docs/adr/0015-research-tool-and-gem-permission.md)). GEM must be credited, and anything redistributed carries the same licence. The permission does not cover hazard source models such as PuSGeN 2024, and legal review is still needed before model data or a derived package leaves KRE.
...
| Model data rights | GEM's public exposure and vulnerability models used under GEM Foundation's written permission; other model data, PuSGeN 2024 included, under one internal-use basis ([ADR 7](../platform/docs/adr/0007-internal-use-licence-basis.md), [ADR 15](../platform/docs/adr/0015-research-tool-and-gem-permission.md)) | Changed after 1.8 | Controls attribution, and whether data or a derived package may leave KRE |
...
> *Changed after 1.8.* Two further changes. CASS is a research tool rather than a governed decision platform, and GEM's exposure and vulnerability models are used under GEM Foundation's written permission ([ADR 15](../platform/docs/adr/0015-research-tool-and-gem-permission.md)).
